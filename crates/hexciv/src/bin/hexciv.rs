...
use hexciv::layer::{
    ...
    LandMilitaryUnitLayerFilter, RiverLayer, RiverLayerFilter, TerrainFeaturesLayer,
    TerrainFeaturesLayerFilter, UnitSelectionLayer, UnitSelectionLayerFilter, UnitStateLayer,
